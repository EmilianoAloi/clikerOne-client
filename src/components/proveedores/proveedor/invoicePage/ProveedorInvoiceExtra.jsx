...
//   const iibbPorcentaje =
//     watch("iibb_porcentaje") ?? watch("percepcion_iibb") ?? 0;

//   // OBTENER IMPUESTOS DEL FORMULARIO
...
//   // SUMA DE OTROS IMPUESTOS (para edición y para carga nueva)
//   const calcOtrosImpuestos = (impuestosArr) =>
//     impuestosArr.reduce((acc, imp) => {
//       // Si viene del backend, priorizá "monto". Si no, calculá.
//       const monto =
//         imp.monto !== undefined
//           ? Number(imp.monto) || 0
...
//   const otrosImpuestos = calcOtrosImpuestos(impuestos);

//   // CALCULAR TOTAL FINAL SUMANDO TODO
//   const totalFinal =
//     (Number(subtotal) || 0) +
//     (Number(iva) || 0) +
//     (Number(iibb) || 0) +
