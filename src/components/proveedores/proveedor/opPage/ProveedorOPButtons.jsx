...
const ProveedorOPButtons = ({
  ...
  return (
    <div className="flex items-center justify-end gap-3 pt-4 mb-0">
      {/* Cancelar */}
      <Button
        variant="outline"
        type="button"
      ...
      >
        {isSubmitting ? (
          ...
          <>
            ...
            {modo === "editar" ? "Modificar OP" : "Guardar OP"}
          </>
        )}
      </Button>
    </div>
...
export default ProveedorOPButtons;
