...
export default function ProveedorNCformExtras({
  formData,
  setFormData,
  handleFileChange,
}) {
  ...
  // Si ya hay un adjunto, cargarlo al FilePond (para editar/ver existente)
  useEffect(() => {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
        ...
        <div className="flex flex-col w-full">
          ...
          >
            ...
            Adjuntar comprobante de Nota de crédito
          </Label>
        ...
        <div className="w-full">
          ...
          >
            ...
            Observaciones de Nota de crédito
          </Label>
          <Textarea
            id="observaciones"
            placeholder="Notas o aclaraciones sobre la nota de crédito..."
            rows={4}
